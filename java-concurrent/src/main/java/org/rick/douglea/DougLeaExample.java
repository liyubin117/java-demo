...
class DougLeaExample {  // Dummy standin for referenced generic "Helper" classes
  void handle() {} 
  void operation() {} 
}
...
class ServerWithStateUpdate {
  ...
  private final DougLeaExample helper = new DougLeaExample();
...
class ServerWithAssignableHelper {
  private double state;
  private DougLeaExample helper = new DougLeaExample();

  synchronized void setHelper(DougLeaExample h) { helper = h; }
...
class OpenCallHost {                     // Generic code sketch
  ...
  protected final DougLeaExample helper = new DougLeaExample(); 
